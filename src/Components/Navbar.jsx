  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="login--btn cursor-pointer">Login</button>

        <div className="social--wrapper flex p-2 gap-6 text-white items-center justify-center">
          <i className="fab fa-facebook cursor-pointer text-3xl"></i>
          <i className="fab fa-twitter cursor-pointer text-3xl"></i>
        </div>
      </div>
